...
class CultivoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cultivo
        fields = [
            'id', 'biohuerto', 'biohuerto_nombre', 'nombre', 'fecha_siembra',
            'etapa', 'etapa_display', 'cantidad', 'unidad', 'fecha_estimada_cosecha',
            'notas', 'estado', 'estado_display', 'dias_para_cosecha', 'created_at', 'updated_at'
        ]
    ...
    def get_dias_para_cosecha(self, obj):
        ...
        if obj.fecha_estimada_cosecha:
            delta = obj.fecha_estimada_cosecha - date.today()
            return delta.days
        return None
